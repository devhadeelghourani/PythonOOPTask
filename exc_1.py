class PlaneException(Exception):
    ...
    def __str__(self):
        print(f"Current Location: {self.current_location[0]}:\
            {self.current_location[1]}")
        print(f"Destination Location: {self.destination_location[0]}:\
            {self.destination_location[1]}")
...
class Plane(Exception):
    ...
    def fly(self, x2, y2):
        ...
        print("The remaining fuel: ", self.get_plane_fuel() - kilometers * 4)
